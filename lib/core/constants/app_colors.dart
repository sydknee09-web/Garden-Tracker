...
class AppColors {
  ...
  // Core neutrals
  static const Color inkBlack    = Color(0xFF1A1612); // near-black with warm undertone
  ...
  // Accent: ember/gold
  static const Color ember       = Color(0xFFB8621A); // fire, primary action
  ...
  static const List<Color> dawnGradient   = [Color(0xFF1F1208), Color(0xFF7A3B1E), Color(0xFFD4813A)];
  static const List<Color> middayGradient = [Color(0xFF3D5A73), Color(0xFF8BA7BC), Color(0xFFD4C9B0)];
  static const List<Color> sunsetGradient = [Color(0xFF1A0A05), Color(0xFF6B2810), Color(0xFFCC5500)];
  static const List<Color> nightGradient  = [Color(0xFF05060F), Color(0xFF0D1526), Color(0xFF1A2540)];

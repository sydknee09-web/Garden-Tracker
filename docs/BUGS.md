...
**Last updated:** 2026-05-14 (U24 Phase A shipped `7207164` — bulk-end handlers now surface errors instead of silent failure; Phase B awaits user retry with instrumented build)

...
**As of 2026-05-12 — Calendar expand-all toggle shipped (`6d76c20`, chunk 3.9 item #1). FAB UX fix batch shipped (`79836f4`, U22+U23). U21 clear-X fix shipped (`fb67e10`). Journal flicker bug repro still pending. 5 remaining current-build items in chunk 3.9.**

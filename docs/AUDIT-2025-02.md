...
- All **client-side** upload paths (vault [id], review-import, import, BatchAddSeed, garden, FeedbackModal, MyPlantsView, journal, AddStoreBoughtPlantModal, journal/new, HarvestModal) use `compressImage()` before uploading.

...
/** Phase 3 luxury polish: semantic colors unchanged; generic “logged” types use emerald-luxury. */
function journalEntryTypeBadgeClass(entryType: string | null | undefined): string {
  switch (entryType) {
    case "harvest":
    ...
    case "vault_add":
    case "prune":
      return "bg-emerald-luxury/10 text-emerald-luxury";
    default:
      return "bg-[#064e3b]/10 text-[#064e3b]";
  }
}
      ...
      <div ref={ref} className="scroll-mt-4">
        ...
        {journalEntries.length === 0 ? (
          ...
          <div className="relative pl-8">
            <div className="absolute left-3 top-0 bottom-0 w-0.5 bg-emerald-luxury/25" aria-hidden="true" />
              ...
              {journalEntries.map((j) => {
                ...
                return (
                  <div key={j.id} className="relative flex gap-4 pb-6 last:pb-0">
                    <div className="absolute left-3 top-2 w-3 h-3 rounded-full bg-emerald-luxury border-2 border-white shadow-sm -translate-x-1/2" aria-hidden="true" />

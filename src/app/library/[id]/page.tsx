          ...
          <>
            {prevId ? (
              <Link
                ...
                className="absolute left-0 top-[40%] md:fixed md:left-[calc(50%-23.5rem)] xl:left-[calc(50%-23.5rem+var(--gt-content-shift))] md:top-1/2 z-10 min-w-[44px] min-h-[44px] hidden md:flex items-center justify-center rounded-full bg-white/90 border border-neutral-200 text-neutral-600 shadow-sm hover:bg-white hover:text-emerald-600 -translate-y-1/2"
            ...
            {nextId ? (
              <Link
                ...
                className="absolute right-0 top-[40%] md:fixed md:right-[calc(50%-23.5rem)] xl:right-[calc(50%-23.5rem-var(--gt-content-shift))] md:top-1/2 z-10 min-w-[44px] min-h-[44px] hidden md:flex items-center justify-center rounded-full bg-white/90 border border-neutral-200 text-neutral-600 shadow-sm hover:bg-white hover:text-emerald-600 -translate-y-1/2"

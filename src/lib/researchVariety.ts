...
- growing_notes: a thorough, practical "how to grow this" narrative — one or more paragraphs of plain prose a home gardener can follow. Synthesize the FULL care picture into this one field: light and watering practice in depth (beyond the short pill), soil preparation and amendments, spacing and any staking/support, feeding/fertilizing cadence, common pests and diseases to watch for and how to respond, and any season-specific care (overwintering, pruning, mulching). This is the richest growing guidance you can assemble from reliable sources — NOT a single sentence. Use empty string ONLY if you genuinely cannot find growing guidance for this plant.
...
- propagation_notes: a detailed "how to propagate this plant" narrative. For each applicable method (cuttings, division, layering, runners, etc.), explain WHEN in the year to do it, the step-by-step technique, and tips for success (rooting conditions, what a healthy take looks like, common failure modes). Preserve practical depth — not a one-line summary. Use empty string only if this plant genuinely cannot be propagated by a home gardener or you cannot find guidance.

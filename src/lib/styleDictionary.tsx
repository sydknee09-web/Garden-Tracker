...
/** Single teardrop leaf for plant profile fallback (1.2 stroke). Same shape as PlantIcon. */
...
/** Chain link / hyperlink — two interlocking link halves. Used for "Link Import" buttons. */
